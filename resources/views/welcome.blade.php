                ...
                <x-authentication-card>
                    ...
                    @if (session('status'))
                        <div class="mb-4 font-medium text-sm text-green-600">
                            <div class="flex">
                                <div class="py-1">
                                    <svg class="w-6 h-6 text-green-800 dark:text-green" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21">
                    ...
                    <form method="POST" action="{{ route('sufragante.send-token') }}">
                        @csrf
