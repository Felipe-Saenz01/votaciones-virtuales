<x-app-layout>
    ...
    <x-authentication-card>
        ...
        <div class="mx-auto font-bold flex justify-between my-5">
            <h1 class="mr-auto">Registro Programas Academicos</h1>
            <form action="{{ route('parametros.programas.destroy', $programa) }}" method="POST">
                @csrf
                @method('delete')
        ...
        <form method="POST" action="{{route('parametros.programas.update',$programa)}}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <x-input id="nombre_programa" class="block mt-1 w-full" type="text" name="nombre_programa" value="{{old('nombre_programa', $programa->nombre_programa)}}" reqquired autofocus />
            </div>
